...
<form name="Appointment Form" method="post"  action="App.php">
<table width="500px">
...
if( $_POST )
{
$con=mysqli_connect("localhost","abhirup","");  
if (!$con)
  {
    die('Could not connect: ' . mysqli_error());
  }
$result = mysqli_select_db($con,"abhirup");
if(!$result) die('db failed'.mysqli_error());

  $users_fname = $_POST['first_name'];
$users_lname = $_POST['last_name'];

$users_depts = $_POST['depts'];
  ...
  $query = "
  INSERT INTO 'Abhirup'.`formdata` (`first_name`, `last_name`, `depts`,'
        `email`, `telephone`, `symptoms`) VALUES ( '".$users_fname."', '".$users_lname."', '".$users_depts."', ' ".$users_email."',
       '".$users_telephone."', ' ".$users_symptoms."')";

$result = mysqli_query($con,$query);
if(!$result) die('result failed'.mysqli_error());
